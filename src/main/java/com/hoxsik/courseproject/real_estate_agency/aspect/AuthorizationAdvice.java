...
import com.hoxsik.courseproject.real_estate_agency.exceptions.AuthorizationException;
...
public class AuthorizationAdvice {
    @Before("@annotation(com.hoxsik.courseproject.real_estate_agency.security.RequiredPrivilege)")
    public void authorize(JoinPoint joinPoint) {
        ...
        for (Object arg : joinPoint.getArgs()) {
            if (arg instanceof DatabaseUserDetails customUserDetails && isUnauthorized(customUserDetails, privilege)) {
                throw new AuthorizationException("У пользователя не было прав на выполнение задачи.");
            }
        }
