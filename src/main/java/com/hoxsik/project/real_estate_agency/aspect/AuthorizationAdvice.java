package com.hoxsik.project.real_estate_agency.aspect;

import com.hoxsik.project.real_estate_agency.exceptions.AuthorizationException;
...
public class AuthorizationAdvice {
    @Before("@annotation(com.hoxsik.project.real_estate_agency.security.RequiredPrivilege)")
