    ...
    return (
        <div className="agents">
            ...
            <p>Выберите из числа квалифицированных и опытных агентов по недвижимости.
                Наша команда обладает богатым опытом, который она применяет в каждой сделке, гарантируя, что вы
                с уверенностью найдете идеальную недвижимость.
                Доверьтесь нашей преданности делу и профессионализму, чтобы воплотить ваши мечты о недвижимости в реальность.
            </p>
            <hr></hr>
